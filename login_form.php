...
<body>
    ...
    <div class="container pt-3 my-5">
        <form action="server.php" method="POST">
            ...
            <input type="text" name="user_name_or_paswd" class="form-control" required placeholder="Enter Name">

            <div class="paswd-container" style="position:relative; max-width:380px;"><label
                    for="user-paswd">Password</label>

                <input type="password" required class="form-control" id="user-paswd" name="user-paswd"
                    style="padding-right:2.5rem;" placeholder="Enter password">
